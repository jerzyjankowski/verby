...
DEEP BACKLOG:
- min font size in card - UI settings
- download all settings and saved lessons from local storage - also upload option
- notifications what changed between versions
- better font size in card
- swipe left goes to previous verb in history, answer can be changed
