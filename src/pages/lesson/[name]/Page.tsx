...
export default function Page() {
  ...
  const { lesson, verbs, round, lastVerbsIds, updateRoundHiddenFlags, canContinue, onContinue, languageConfig } = useLesson(name)
  ...
  return (
    <div className="h-dvh bg-primary text-primary-text p-4">
      <div className="mx-auto flex h-full max-w-2xl flex-col gap-3">
        <LessonSettings lesson={lesson} verbs={verbs} lastVerbsIds={lastVerbsIds} languageConfig={languageConfig} />
