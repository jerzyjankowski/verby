...
export default function Sheet({
  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 z-40 bg-black/60 data-[state=open]:animate-[verby-overlay-in_220ms_ease-out] data-[state=closed]:animate-[verby-overlay-out_180ms_ease-in]" />
